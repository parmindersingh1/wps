...
if($_GET['id']) {
	$vehicleID = $_GET['id'];
	 $sql    = "SELECT * FROM tbl_archived_vehicles WHERE vehicleID = :vehicle_id";
				...
				<div class="panel panel-default">
                 ...
                 <div class="panel-footer">                       
                        <span class="pull-right">
                            <a href="edit.html" data-original-title="Edit this Vehicle" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
                            <a data-original-title="Remove this Vehicle" data-toggle="tooltip" type="button" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                        </span>
                    </div>
